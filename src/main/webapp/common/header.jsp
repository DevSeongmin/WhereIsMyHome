...
<header>
    ...
    <div
        class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
         ...
         <span class="fs-4"  ><a href="${root}/index.jsp" class="text-decoration-none">CozyHouse</a></span>
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
            ...
            <c:if test="${not empty sessionScope.loginInfo }">
                ...
                <a class="me-3 py-2 text-dark text-decoration-none" href="${root}/board?action=list"> [공지 사항] </a>
                <a class="me-3 py-2 text-dark text-decoration-none" href="${root }/user?act=mypage&userId="${loginInfo.id}> [마이페이지] </a>
            <a class="me-3 py-2 text-dark text-decoration-none" href="${root }/user?act=logout"> [로그아웃] </a>
            </c:if>
        </nav>
    </div>
